export const FLASHDUELSABI = [
    ...
    {
        "inputs": [],
        "name": "totalProtocolFeesGenerated",
        "outputs": [
            {
                "internalType": "uint256",
                "name": "",
