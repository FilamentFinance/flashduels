...
const YesNoButton: React.FC<YesNoButtonProps> = ({ text, color, onClick, isSelected }) => {
  const baseClasses = "flex-1 shrink gap-2.5 p-2.5 rounded-lg border border-solid focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200 w-48";
  const colorClasses = {
