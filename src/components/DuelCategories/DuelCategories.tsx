...
const DuelCategories = ({ specialCategoryIndex, setSpecialCategoryIndex }: { specialCategoryIndex: number | null, setSpecialCategoryIndex: (specialCategoryIndex: number | null) => void }) => {
