...
export const OrdersTable = ({ duelId }: { duelId: string }) => {
  ...
  return (
    <div className="flex flex-col rounded-lg border-2 border-solid shadow-sm bg-neutral-900 border-neutral-800 w-full">
      ...
      <div className="flex flex-col w-full min-h-[250px]">
        {openOrders.length != 0 ? (
          <>
            {' '}
            <div className="flex w-full text-xs font-medium tracking-normal leading-none whitespace-nowrap text-stone-300">
          ...
          <span className="flex justify-center w-full text-xs font-medium tracking-normal leading-none text-stone-300">
            No open orders
          </span>
        )}
      </div>
